...
def test_reentry_dwell_session_correction(db_session):
    ...
    events = [
        DBEvent(
            event_id="e1", store_id="ST1008", camera_id="CAM_ENTRY_01", visitor_id="VIS_RE",
            event_type="ENTRY", timestamp="2026-04-10T16:40:00Z", zone_id="ENTRY", confidence=0.95,
            metadata_json={"session_seq": 1}
        ),
        DBEvent(
            event_id="e2", store_id="ST1008", camera_id="CAM_ENTRY_01", visitor_id="VIS_RE",
            event_type="EXIT", timestamp="2026-04-10T16:40:30Z", zone_id="ENTRY", confidence=0.95,
            metadata_json={"session_seq": 2}
        ),
        DBEvent(
            event_id="e3", store_id="ST1008", camera_id="CAM_ENTRY_01", visitor_id="VIS_RE",
            event_type="REENTRY", timestamp="2026-04-10T16:42:30Z", zone_id="ENTRY", confidence=0.95,
            metadata_json={"session_seq": 3}
        ),
        DBEvent(
            event_id="e4", store_id="ST1008", camera_id="CAM_ENTRY_01", visitor_id="VIS_RE",
            event_type="EXIT", timestamp="2026-04-10T16:43:10Z", zone_id="ENTRY", confidence=0.95,
